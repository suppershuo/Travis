...
//	}
	...
	public EditPasswordFrm() {
		...
		}else if("客户".equals(MainFrm.userType.getName())){
			Customer student = (Customer)MainFrm.userObject;
			currentUserLabel.setText("【客户】" + student.getName());
		}
	}
	...
	protected void submitEdit(ActionEvent e) {
		...
		if("客户".equals(MainFrm.userType.getName())){
			...
			Customer studentTmp = new Customer();
			Customer student = (Customer)MainFrm.userObject;
